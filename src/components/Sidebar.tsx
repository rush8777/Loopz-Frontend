import { BarChart2, Grip, UserRoundPen, BookOpen, CheckSquare, ChevronDown, FileText, Flame, Gauge, LayoutTemplate, ListChecks, MousePointerClick, Network, PanelLeftClose, PanelLeftOpen, Settings, Users, Waypoints, X } from "lucide-react";
...
const SECTIONS: NavSection[] = [
  ...
  { label: "Experiences", items: [{ label: "Modals", path: "/experiences/modals", icon: BookOpen }, { label: "Surveys", path: "/experiences/surveys", icon: ListChecks }, { label: "Guides", path: "/experiences/guides", icon: LayoutTemplate  }, { label: "Banners", path: "/experiences/banners", icon: Grip }, { label: "Checklists", path: "/experiences/checklists", icon: CheckSquare }] },
