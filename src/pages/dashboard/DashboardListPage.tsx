...
export function DashboardListPage() {
  ...
  return <div><PageHeader section="Workspace" title="Overview" description="Reusable product analytics for this site." actions={canEdit ? <Button onClick={() => navigate("/dashboard/new")}><Plus />New dashboard</Button> : undefined} />
